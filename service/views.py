    ...
    for documento in documentos:
        ...
        try:
            ...
            for viagem in data.get("viagem", []):
                ...
                # Define a empresa com base no documento
                empresa = "ComandoLog" if documento == "61064929000179" else "Parada"
                ...
                processed_viagem = {
                    ...
                    "detalhes": { # Agrupa os detalhes aqui
                        ...
                        "descricaoLocal": posicao.get("descricaoLocal") or viagem.get("descricaoLocal") or "N/A",
                        "dataPosicao": posicao.get("dataPosicao") or viagem.get("dataPosicao") or "N/A",
